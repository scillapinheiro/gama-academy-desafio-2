    ...
    for(i=0; i<listaProdutos.length; i++){
        let produto = listaProdutos[i];
            if (produto.emDestaque == "sim" && produto.disponivel == "sim"){
                totalEstDisp += produto.qtdEstoque;
        }
    }
    console.log("Total de produtos em estoque disponíveis e em destaque = "+totalEstDisp);
}
...
function exercicio8(){
    ...
    for(i=1; i<listaProdutos.length; i++){
        ...
        if (produto.qtdEstoque > 0){
            if (produto.preco * produto.qtdEstoque > produtoMaisValioso.preco * produtoMaisValioso.qtdEstoque){
...
function exercicio10(){
    ...
    for (i=0;i<listaProdutos.length; i++){
        ...
        if (produto.qtdEstoque >= 1){
            ...
            somatoriaItens += produto.qtdEstoque;
